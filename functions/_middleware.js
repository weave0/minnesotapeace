  ...
  if (isGood) {
    body = body
      ...
      .replace(
        ...
        '<div class="map-story-index">9</div><div><div class="map-story-top"><span class="map-story-place">Red Wing</span><span class="map-story-type">Annual city program</span></div><h3>Bike safety is a recurring police-community event.</h3><p>Red Wing describes its Bike Rodeo as an annual spring event where children practice riding skills on a simulated road course, with prizes and refreshments provided.</p><div class="map-story-links"><a href="https://www.redwingmn.gov/256/Other-Red-Wing-Police-Crime-Prevention-P">City of Red Wing · annual Bike Rodeo →</a></div></div>'
      );
