/* MN Peace public discovery bridge — versioned to prevent stale edge asset reuse. */
(function () {
  "use strict";
  ...
  function addHomepageDiscovery() {
    ...
    section.innerHTML = [
      ...
      '    <p>The homepage gives you the arc. The deeper desks separate current outcomes from the original charging record, decode the institutions and oversight failures, and now document Minnesotans doing tangible work for other Minnesotans.</p>',
      '  </div>',
