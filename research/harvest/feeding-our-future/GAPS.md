...
- **Docket index now obtained (2026-08-29 pass).** The full official register of actions for case **62-CV-20-5492** (Feeding Our Future vs. MDE, Ramsey County) was retrieved directly from Minnesota Court Records Online (`src-mncro-62-cv-20-5492-register-of-actions`): every docket entry's date, document type, and page count from filing (2020-11-20) through dismissal without prejudice (2022-02-02), plus the judge-reassignment history (Guthmann 2020-11-20 through ~2021-07-27; reassigned to Judge Patrick C. Diamond 2021-08-12).
- **Still open:** the actual PDF text of any filed brief, motion, or order was **not** retrieved. MCRO's document download is a per-document CSRF-protected form POST tied to a live browser session, not a fetchable static URL, and could not be automated in this pass. Getting the text of specific filings (e.g., Index #95 or #120, the most likely candidates for the ~June/July 2021 contempt order and its sanction amount; Index #32, FOF's April 23 contempt motion; Index #42-#50, the April 30 filings) requires either a manual MCRO session or a records request.
- Journalism reports a contempt sanction in this case, but with **inconsistent amounts**: this file previously recorded "$35,750," while a 2021-07-02 Sahan Journal article found in this pass reports "more than $47,000 in penalties and attorney fees." Neither figure has been matched to a specific docket index yet; do not treat either as confirmed until the underlying order (most likely Index #95, 2021-06-24, or Index #120, 2021-07-15) is read directly.
