...
- **New in this pass (2026-08-29):** the Ramsey County register of actions (case 62-CV-20-5492, see item 9) reveals a **second** Temporary Restraining Order Hearing on **2021-04-30 itself** -- the same day MDE removed the stop-pay -- that was not previously reflected anywhere in this corpus. Neither OLA's account nor Korte's or Honer's interviews specifically address this second hearing. It is a contemporaneity, not yet a causal link: whether MDE's decision was made before, during, or in response to that hearing requires the hearing's order or transcript, which was not retrieved. Docket index/document status for the Ramsey County case generally is now tracked under item 9 rather than as a separate gap here.
