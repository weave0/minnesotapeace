...
- **Still open:** other individual filings (the April 30 briefs/affidavits at Index #42-#50, MDE's opposition briefs, the July 15, 2021 order at Index #120) were not retrieved. The retrieval technique that worked -- replicating MCRO's per-document download as an authenticated `fetch()` POST from within an active browser session, since a synthetic `.click()` on the download button did not trigger the request but a real click did -- is documented here so a future pass doesn't have to rediscover it.
...
- **Sequencing question RESOLVED (2026-08-30 pass).** The April 30 second-hearing puzzle from the prior pass is closed: FOF's own reply brief, filed 1:19 PM on 2021-04-30 (before that day's 3:00 PM hearing), quotes MDE's opposition brief directly -- MDE itself said it removed the stop-pay "pursuant to the Court's guidance at the April 21, 2021, hearing." The stop-pay was lifted before the April 30 hearing, and MDE's own contemporaneous filing attributes it to April 21, not April 30. The June 24, 2021 written order independently confirms the same thing in the court's own words (see item 9). One loose end remains: FOF argued in that same reply that removing the stop-pay *flag* is not the same as actually *paying* the claims, so the exact date full payment was completed is not pinned down by these documents.
- **New in this pass (2026-08-30):** FOF's Second Amended Complaint, filed the evening of 2021-04-30 (6:51 PM, after the hearing), named **Daron Korte personally** ("officially and personally") as a defendant alongside MDE. Added as context to the Korte source record and the payment-resumption claim: he was a personal litigant in this exact matter, not a disinterested witness, when he later gave his 2026 congressional account. This does not establish inaccuracy in his testimony -- which has independently checked out against the primary record on every specific point verified so far -- but it belongs in the record.
- Two numerical claims about denied applications are unreconciled: FOF's April 30 reply says MDE denied **149** pending applications on April 29; the June 24 order says **143** of 144 site-ID applications were denied in an April 29 letter. Not resolved in this pass.
